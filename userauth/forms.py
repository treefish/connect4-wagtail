...
#    photo_consent = forms.BooleanField(label=_("Photo consent?"), help_text=_("Allow photography of family for promotional use?"))
    ...
    additional_information = forms.CharField(max_length=30, required=False, label=_("Additional information"), help_text=_("Information of importance for event staff to know about your family."))
